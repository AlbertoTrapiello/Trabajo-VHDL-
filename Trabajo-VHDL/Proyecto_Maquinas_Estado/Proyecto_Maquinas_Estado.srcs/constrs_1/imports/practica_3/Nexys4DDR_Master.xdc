...
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { start }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { mode }]; #IO_L24P_T3_35 Sch=sw[12]
#set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports start]
#set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports mode]
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L21P_T3_DQS_14 Sch=sw[15]


## LEDs

set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports { led_correcto }];
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports { led_incorrecto }];
...
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { led[10] }]; #IO_L16P_T2_CSI_B_14 Sch=led[12]
...
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { digsel[7] }]; #IO_L23P_T3_FOE_B_15 Sch=an[0]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { digsel[6] }]; #IO_L23N_T3_FWE_B_15 Sch=an[1]
set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { digsel[5] }]; #IO_L24P_T3_A01_D17_14 Sch=an[2]
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { digsel[4] }]; #IO_L19P_T3_A22_15 Sch=an[3]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { digsel[3] }]; #IO_L8N_T1_D12_14 Sch=an[4]
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { digsel[2] }]; #IO_L14P_T2_SRCC_14 Sch=an[5]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { digsel[1] }]; #IO_L23P_T3_35 Sch=an[6]
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { digsel[0] }]; #IO_L23N_T3_A02_D18_14 Sch=an[7]
...
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {p[0]}];
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports {p[1]}];
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports {p[2]}];
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports {p[3]}];
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports {p[4]}];
...
#set_property IOSTANDARD LVCMOS33 [get_ports {display4[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display4[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display4[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display4[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display4[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display4[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display4[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display5[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display5[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display5[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display5[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display5[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display5[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {display5[0]}]
